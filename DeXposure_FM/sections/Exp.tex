...
& 1 & \textbf{0.994} & \textbf{0.967} & \textbf{2.54} & \textbf{3.42} & \textbf{0.058} & \textbf{0.400} \\
& 3 & \textbf{0.994} & \textbf{0.966} & \textbf{2.54} & \textbf{3.48} & \textbf{0.115} & \textbf{0.605} \\
& 7 & \textbf{0.994} & \textbf{0.967} & \textbf{2.55} & \textbf{3.49} & \textbf{0.197} & \textbf{0.840} \\
& 14 & \textit{TBD} & \textit{TBD} & \textit{TBD} & \textit{TBD} & \textit{TBD} & \textit{TBD} \\
\hline
\multirow{4}{*}{GraphPFN-Frozen}
& 1 & 0.988 & 0.937 & 3.25 & 4.26 & \textbf{0.058} & 0.401 \\
& 3 & 0.987 & 0.934 & 3.25 & 4.29 & 0.118 & 0.606 \\
& 7 & 0.987 & 0.936 & 3.21 & 4.25 & 0.196 & 0.845 \\
& 14 & 0.985 & 0.931 & 3.19 & 4.32 & 0.298 & 1.132 \\
\hline
\multirow{4}{*}{ROLAND}
& 1 & 0.957 & 0.856 & 3.33 & 4.30 & 0.061 & 0.403 \\
& 3 & \textit{TBD} & \textit{TBD} & \textit{TBD} & \textit{TBD} & \textit{TBD} & \textit{TBD} \\
& 7 & \textit{TBD} & \textit{TBD} & \textit{TBD} & \textit{TBD} & \textit{TBD} & \textit{TBD} \\
& 14 & \textit{TBD} & \textit{TBD} & \textit{TBD} & \textit{TBD} & \textit{TBD} & \textit{TBD} \\
\hline
\end{tabular}
...
\begin{enumerate}
  \item \textbf{Edge existence:} DeXposure-FM achieves consistently high performance across horizons with AUROC 0.994 and AUPRC 0.966--0.967, outperforming GraphPFN-Frozen (0.985--0.988/0.931--0.937) and ROLAND (0.957/0.856 at h=1).
  \item \textbf{Edge weight:} DeXposure-FM shows substantial and stable improvement in weight prediction with MAE 2.54--2.55 across h=1/3/7, vs.\ 3.19--3.25 (Frozen) and 3.33 (ROLAND), a 22\% reduction.
  \item \textbf{Node prediction:} Node TVL change prediction degrades with horizon as expected: DeXposure-FM MAE increases from 0.058 (h=1) to 0.197 (h=7), comparable to Frozen (0.058--0.196).
  \item \textbf{Horizon stability:} DeXposure-FM maintains stable edge prediction across horizons while Frozen shows slight degradation. h=14 results are \textit{TBD}.
\end{enumerate}
...
\paragraph{Results.}
Table~\ref{tab:shock-results} shows network structure changes during the two stress events (\textit{TBD}).
...
\hline
Terra/Luna & \textit{TBD} & \textit{TBD} & \textit{TBD} & \textit{TBD} \\
FTX & \textit{TBD} & \textit{TBD} & \textit{TBD} & \textit{TBD} \\
\hline
\end{tabular}
\caption{Network structure changes during stress events. Values are \textit{TBD} pending shock analysis runs.}
...
Table~\ref{tab:contagion-results} presents contagion simulation results (\textit{TBD}).
...
\hline
Single protocol (50\% shock) & \textit{TBD} & \textit{TBD} & \textit{TBD} \\
Multi-protocol (random 5) & \textit{TBD} & \textit{TBD} & \textit{TBD} \\
Stablecoin cluster & \textit{TBD} & \textit{TBD} & \textit{TBD} \\
Bridge exploit (simulated) & \textit{TBD} & \textit{TBD} & \textit{TBD} \\
\hline
\end{tabular}
\caption{Contagion simulation results on 2025 network snapshot. Values are \textit{TBD}.}
...
\paragraph{Results.}
Table~\ref{tab:imputation-results} summarizes imputation performance using DeXposure-FM (\textit{TBD}).
...
20\% & \textit{TBD} & \textit{TBD} & \textit{TBD} \\
30\% & \textit{TBD} & \textit{TBD} & \textit{TBD} \\
\hline
\end{tabular}
\caption{Imputation performance at different masking rates using DeXposure-FM. Values are \textit{TBD}.}
...
Mean edge overlap and horizon-stability comparisons are \textit{TBD} until all horizons complete.

\paragraph{Trade-offs in weight prediction.}
Raw vs. TVL-weighted MAE comparisons are \textit{TBD} pending full metric aggregation.

\paragraph{Practical implications.}
Practical implications (horizon stability and imputation recall) are \textit{TBD} until remaining experiments complete.

\paragraph{Limitations.}
Current results are partial. Full training with additional epochs and completed horizons is \textit{TBD}.
