...
\begin{enumerate}
  ...
  \item \textbf{Node prediction:} Node TVL change prediction degrades with horizon as expected: DeXposure-FM MAE increases from 0.056 ($h=1$) to 0.286 ($h=12$), reflecting growing uncertainty in longer-term forecasts.
