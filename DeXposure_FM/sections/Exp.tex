...
\paragraph{Robust imputation enables data augmentation.}
The model's 98\%+ edge recall at 30\% masking suggests practical applications: (i) reconstructing incomplete network observations from partial API data, (ii) validating data collection pipelines by cross-checking imputed vs.\ observed edges, and (iii) generating synthetic stress scenarios by selectively masking high-importance edges.
