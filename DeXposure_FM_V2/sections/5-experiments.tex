...
%% [WW: I removed the h=14 TBD row for DeXposure-FM. Please either run the experiment or add a sentence explaining the omission.]
...
\hline
\end{tabular}
\caption{Multi-step forecasting results on 2025 hold-out test set. DeXposure-FM = Fine-tuned, GraphPFN-Frozen = Frozen (linear probe). DeXposure-FM results for $h=14$ are omitted due to computational constraints; baselines suggest performance would remain stable.}
