...
A LiMiX transformer %\fh{\cite{eremeev2025turningtabularfoundationmodels}} %within GraphPFN 
produces %\fh{per-feature embeddings} 
for each node. For link prediction, we extract node representations by mean-pooling %\fh{\cite{eremeev2025turningtabularfoundationmodels}} 
over the \textit{feature column embeddings} %\fh{\cite{eremeev2025turningtabularfoundationmodels}} 
rather than using the label column embedding %\fh{\cite{eremeev2025turningtabularfoundationmodels}} 
