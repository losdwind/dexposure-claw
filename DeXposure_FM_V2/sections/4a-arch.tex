...
Here $h^{\mathrm{in}}_{p,\tau}$ and $h^{\mathrm{out}}_{p,\tau}$ denote simple weighted aggregations of incoming/outgoing neighbor embeddings at time $\tau$ (using the current-week edge weights), which inject local flow context into the TVL-change prediction.
