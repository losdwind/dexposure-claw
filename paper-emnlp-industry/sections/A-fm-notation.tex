...
$10^{-5}$ for the backbone). Training uses $104$ weekly snapshots
(March 2020--January 2024), validation uses $12$ weeks
(February--April 2024), and the leaderboard test split is the
remaining $33$ weeks (\S\ref{app:bench-details}). Full-graph
in-context inference fits a single RTX~4090; one weekly forecast
across all four horizons completes in well under a minute.

Held-out link-prediction quality on the validation split is
