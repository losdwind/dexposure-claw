...
- sections/3-pipeline.tex (combines old 3-Pre + 4-Alg, compressed)
- sections/4-bench.tex (compressed from old 5-Bench)
- sections/5-results.tex (compressed from old 6-Exp)
- sections/6-lessons.tex (NEW — Deployment Lessons section)
- sections/7-conclusion.tex (short)
- sections/8-limitations.tex (lightly adapted from old 7-Limitations)
- sections/9-ethics.tex (NEW)
