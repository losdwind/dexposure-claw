...
Eight reference methods are bundled with the harness, sufficient to
...
The eight listed in Table~\ref{tab:bench-methods} together expose all
...
leaderboard run, including all eight reference methods and the LLM
