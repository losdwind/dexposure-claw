...
from lib.agent.types import GraphSnapshot, NodeFeatures, Edge, AgentOutput
...
async def test_run_epoch_returns_agent_output(sample_graph, mock_prediction):
    ...
    with patch("lib.agent.agent_loop.call_forecast_api", new_callable=AsyncMock, return_value=mock_prediction):
