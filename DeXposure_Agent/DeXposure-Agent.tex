...
We presented \textsc{DeXposure-Claw}, a four-layer query architecture that turns predicted exposure graphs into supervisory tickets with explicit data-health and confidence gates, and \textsc{DeXposure-Bench}, a six-axis evaluation suite for FM\,+\,LLM decision pipelines on temporal exposure graphs.
