...
from lib.limix.model.layer import EncoderBaseLayer, MLP, LayerStack
from typing import Any, Literal
from lib.limix.model.encoders import get_x_encoder, get_cls_y_encoder, get_reg_y_encoder, preprocesss_4_x
    ...
    def forward(self, x: torch.Tensor, 
        ...
        if checkpointing:
            encoder_x = partial(
                ...
                self.encoder_x, use_reentrant=False,
                preserve_rng_state=True,
            )
        else:
            encoder_x = self.encoder_x
        x_encoder_result = encoder_x(preprocessed_x)
